...
bool ASTVisitor::Visit(DoWhileNode* node){ return true; }
bool ASTVisitor::Visit(ForNode* node){ return true; }
bool ASTVisitor::Visit(CaseNode* node){ return true; }
bool ASTVisitor::Visit(SwitchNode* node){ return true; }
...
bool ASTVisitor::Visit(ReturnNode* node){ return true; }

// Expression
bool ASTVisitor::Visit(AssignNode* node){ return true; }
bool ASTVisitor::Visit(OpAssignNode* node){ return true; }
bool ASTVisitor::Visit(AddressNode* node){ return true; }
bool ASTVisitor::Visit(BinaryOpNode* node){ return true; }
bool ASTVisitor::Visit(LogicalAndNode* node){ return true; }
bool ASTVisitor::Visit(LogicalOrNode* node){ return true; }
bool ASTVisitor::Visit(CastNode* node){ return true; }
bool ASTVisitor::Visit(CondExprNode* node){ return true; }
bool ASTVisitor::Visit(FuncCallNode* node){ return true; }
bool ASTVisitor::Visit(ArrayRefNode* node){ return true; }
bool ASTVisitor::Visit(DereferenceNode* node){ return true; }
bool ASTVisitor::Visit(MemberRefNode* node){ return true; }
