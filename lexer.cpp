...
//=============================================================================
// Wordchecker
bool WordChecker::isToken(int look, TokenType toktype) {
  return (tk_->GetToken(look).type == toktype);
}

// name : id
bool WordChecker::isName(int look) {
  return isToken(look, Lexer::TokIdentifier);
}

bool WordChecker::isStorage(int look) {
  return isToken(look, Lexer::TokStatic);
}

bool WordChecker::isType(int look) {
...
Token WordChecker::GetToken(int look) {
  return tk_->GetToken(look);
}

void WordChecker::ConsumeToken(int count) {
  tk_->ConsumeToken(count);
}
